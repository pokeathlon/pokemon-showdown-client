	...
	addSideCondition(siden: number, id: ID, instant?: boolean) {
		...
		case 'permafrost':
			...
			if (frostArray.length < 1 && frostLevels >= 1) {
				const spike1 = new Sprite(BattleEffects.icicle, {
					display: 'block',
					x: x + 5,
					y: y - 40,
					z: side.z,
			...
			if (frostArray.length < 2 && frostLevels >= 2) {
				const spike2 = new Sprite(BattleEffects.icicle, {
					display: 'block',
					x: x - 15,
					y: y - 35,
					z: side.z,
			...
			if (frostArray.length < 3 && frostLevels >= 3) {
				const spike3 = new Sprite(BattleEffects.icicle, {
					display: 'block',
					x: x + 50,
					y: y - 40,
					z: side.z,
			...
			if (frostArray.length < 4 && frostLevels >= 4) {
				const spike4 = new Sprite(BattleEffects.icicle, {
					display: 'block',
					x: x + 20,
					y: y - 35,
					z: side.z,
		...
		case 'livewire':
			...
			if (wireArray.length < 1 && wireLevels >= 1) {
				const spike1 = new Sprite(BattleEffects.lightning, {
					display: 'block',
					x: x + 5,
					y: y - 40,
					z: side.z,
			...
			if (wireArray.length < 2 && wireLevels >= 2) {
				const spike2 = new Sprite(BattleEffects.lightning, {
					display: 'block',
					x: x - 15,
					y: y - 35,
					z: side.z,
			...
			if (wireArray.length < 3 && wireLevels >= 3) {
				const spike3 = new Sprite(BattleEffects.lightning, {
					display: 'block',
					x: x + 50,
					y: y - 40,
					z: side.z,
			...
			if (wireArray.length < 4 && wireLevels >= 4) {
				const spike4 = new Sprite(BattleEffects.lightning, {
					display: 'block',
					x: x + 20,
					y: y - 35,
					z: side.z,
...
const BattleMusicMario: {[k: string]: AnyObject} = {
	...
	'fx/music/vs-antasma.mp3': {
		title: 'vs. Antasma',
		composer: 'ShadedUmbreon',
		loopstart: 41837,
		loopend: 94027,
	},
	'fx/music/vs-ashley.mp3': {
		title: 'vs. Ashley',
		composer: 'Rainbow Hedgehog',
		loopstart: 27317,
		loopend: 64822,
	},
	'fx/music/vs-bowser.mp3': {
		title: 'vs. Bowser',
		composer: 'Mimi/Kobazco',
		loopstart: 48456,
		loopend: 144457,
	},
	'fx/music/vs-captures-commanders.mp3': {
		title: 'vs. Captures & Commanders',
		composer: 'Mimi',
		loopstart: 53185,
		loopend: 125754,
	},
	'fx/music/vs-elite-four.mp3': {
		title: 'vs. Elite Four',
		composer: 'MysteryMan',
		loopstart: 39364,
		loopend: 80983,
	},
	'fx/music/vs-gigabowser.mp3': {
		title: 'Giga Bowser',
		composer: 'Shadow Yoshi',
		loopstart: 48197,
		loopend: 109278,
	},
	'fx/music/vs-jimmy.mp3': {
		title: 'vs. Jimmy T.',
		composer: 'Mrsonic699',
		loopstart: 43007,
		loopend: 107038,
	},
	'fx/music/vs-koopa-troop.mp3': {
		title: 'Showtime! vs. Koopa Troop',
		composer: 'Mimi',
		loopstart: 42910,
		loopend: 122910,
	},
	'fx/music/vs-legendary-capture.mp3': {
		title: 'vs. Legendary Capture',
		composer: 'Toast',
		loopstart: 55031,
		loopend: 109857,
	},
	'fx/music/vs-luigi.mp3': {
		title: 'vs. Luigi',
		composer: 'MiDi-D',
		loopstart: 29459,
		loopend: 94819,
	},
	'fx/music/vs-champion.mp3': {
		title: 'vs. Champion',
		composer: 'Mimi',
		loopstart: 89728,
		loopend: 255797,
	},
	'fx/music/vs-penny.mp3': {
		title: 'vs. Penny',
		composer: 'GoateeMan',
		loopstart: 27149,
		loopend: 105203,
	},
	'fx/music/vs-star-leader.mp3': {
		title: 'vs. Star Leader',
		composer: 'Dentelle',
		loopstart: 38270,
		loopend: 100392,
	},
	'fx/music/vs-super-sonic.mp3': {
		title: 'vs. Super Sonic',
		composer: 'Shadrow',
		loopstart: 63016,
		loopend: 265390,
	},
