...
abstract class BattleTypedSearch<T extends SearchType> {
	...
	protected firstLearnsetid(speciesid: ID) {
		...
		if (['gen9infinitefusion', 'gen7infinitefusion', 'gen9pokeathlon', 'gen9pokeathlon2', 'gen9insurgence', 'gen6insurgence', 'gen9uranium', 'gen6uranium', 'gen9infinity', 'gen6infinity', 'gen9mariomon', 'gen9chaos', 'gen9chaosfusion', 'gen9rejuvenation'].includes(this.dex.modid)) table = table[this.dex.modid];
...
class BattleMoveSearch extends BattleTypedSearch<'move'> {
	...
	getBaseResults() {
		...
		if (['gen9infinitefusion', 'gen7infinitefusion', 'gen9pokeathlon', 'gen9pokeathlon2', 'gen9insurgence', 'gen6insurgence', 'gen9uranium', 'gen6uranium', 'gen9infinity', 'gen6infinity', 'gen9mariomon', 'gen9chaos', 'gen9chaosfusion', 'gen9rejuvenation'].includes(this.dex.modid)) lsetTable = lsetTable[this.dex.modid];
		while (learnsetid) {
