	...
	var AltFormPopup = this.AltFormPopup = Popup.extend({
		...
		initialize: function (data) {
			...
			for (var i = 0; i < formCount; i++) {
				...
				}  else if (species.tags.includes('Xenoverse')) {
					buf += 'background-image: url(https://play.pokeathlon.com/sprites/fangame-sprites/xenoverse/front/' + baseid + toID(formid) + '.gif); width: 120px; height: 120px; background-size: 120px;" class="option';
				} else {
