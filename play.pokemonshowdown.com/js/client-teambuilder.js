	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		updateTeamView: function () {
			...
			if (this.exportMode) {
				...
				// buf += '<p><button name="psExport" type="submit" class="button exportbutton"> <i class="fa fa-upload"></i> Upload to Pok&eacute;athlon database (saves across devices)</button>';
		...
		renderSet: function (set, i) {
			...
			buf += '" class="setchart" style="' + Dex.getTeambuilderSprite(set, this.curTeam.dex) + ';">';
			...
			if (this.curTeam.gen > 1) {
				...
				} else if (this.curTeam.gen < 8 || isNatDex || (this.curTeam.format in window.Formats && ['gen9mariomon', 'gen9mariomondev', 'gen9pokeathlon', 'gen9chaos', 'gen9chaosfusion'].includes(window.Formats[this.curTeam.format].mod))) {
